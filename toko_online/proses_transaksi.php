...
if (isset($_GET['id'])) {
    ...
    // Ambil detail produk
    $query = mysqli_query($koneksi, "SELECT * FROM toko_produk WHERE id_produk = '$id_produk'");
    ...
    try {
        ...
        $insert_transaksi = mysqli_query($koneksi, "INSERT INTO toko_transaksi (id_pelanggan, id_petugas, tgl_transaksi) VALUES ('$id_pelanggan', '$id_petugas', NOW())");
