...
if($_POST){
    ...
    if(empty($nama_petugas)){
        ...
        include "koneksi.php";
        if(empty($password)){
            $update=mysqli_query($koneksi,"update toko_petugas set nama_petugas='".$nama_petugas."', username='".$username."', password='".$password."', level='".$level."' where id_petugas = '".$id_petugas."' ") or die(mysqli_error($koneksi));
            if($update){
