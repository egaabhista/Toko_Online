...
if (isset($_POST['jumlah_beli']) && isset($_GET['id_produk'])) {
    ...
    try {
        ...
        $insert_transaksi = mysqli_query($koneksi, "INSERT INTO toko_transaksi (id_pelanggan, id_petugas, tgl_transaksi) VALUES ('$id_pelanggan', " . ($id_petugas ? "'$id_petugas'" : "NULL") . ", '$tgl_transaksi')");
        ...
        // Ambil harga produk
        $query_produk = mysqli_query($koneksi, "SELECT harga FROM toko_produk WHERE id_produk = '$id_produk'");
        ...
        $insert_detail = mysqli_query($koneksi, "INSERT INTO toko_detail_transaksi (id_transaksi, id_produk, qty, subtotal) VALUES ('$id_transaksi', '$id_produk', '$qty', '$subtotal')");
